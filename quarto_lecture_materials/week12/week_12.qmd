...
- One more quick review of list vs. string
- Answers to recursive code-writing practice problems
- Test-taking and interview strategy: mapping new problems to known problems
- Strategies for working together fairly (important for future courses!)
